        ...
        <div className="w-full max-w-md">
          <Tabs defaultValue="login" className="w-full" dir="rtl">
            ...
            <TabsContent value="register">
              <Card className="border-border/50 shadow-xl">
                <CardHeader className="space-y-1 text-center">
                  <CardTitle className="text-2xl font-heading font-bold">إنشاء حساب جديد</CardTitle>
                  <CardDescription>انضم إلى منصة حرفتي اليوم</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  {role === "artisan" && (
                    <div className="space-y-2 text-right">
                      ...
                      <div className="relative">
                        ...
                        <Input id="reg-phone" placeholder="06XXXXXXXX" className="pr-9" />
                      </div>
                    </div>
                  )}
                  <div className="space-y-2 text-right">
                ...
                <CardFooter>
                  <Button className="w-full bg-primary hover:bg-primary/90 font-bold" onClick={() => setLocation(role === "artisan" ? "/subscription" : "/")}>
                    إنشاء الحساب
                  </Button>
                </CardFooter>
              </Card>
